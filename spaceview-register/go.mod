module local-spaceview-register

go 1.25.7

require (
	github.com/anyproto/any-sync v0.12.3
	github.com/anyproto/anytype-heart v0.0.0
...
replace github.com/araddon/dateparse => github.com/mehanizm/dateparse v0.0.0-20210806203422-f82c8742c9f8
